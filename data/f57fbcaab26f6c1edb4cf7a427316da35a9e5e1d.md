...
- Name: eGündem İletişim Sayfası Testleri >> EGT-42 - Formdaki input alanları doğru tipte olmalı
- Location: /home/runner/work/egundem/egundem/tests/iletisim.spec.js:49:3
...
Locator: locator('input[type="email"][name="email"]')
Expected: 1
Received: 0
Call log:
  - expect.toHaveCount with timeout 5000ms
  - waiting for locator('input[type="email"][name="email"]')
    9 × locator resolved to 0 elements
      - unexpected value "0"

    at /home/runner/work/egundem/egundem/tests/iletisim.spec.js:53:30
```
