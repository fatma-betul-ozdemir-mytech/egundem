...
Call log:
  - waiting for locator('a[href*="/haber/"]').first()

    at /home/runner/work/egundem/egundem/tests/haberler.spec.js:38:21
```
...
- link "E-Gündem Haberleri & Son Dakika Haberleri E-Gündem Logo":
  ...
  - img "E-Gündem Logo"
- link "Fenerbahçeli Fred transfer görüşmesini resmen açıkladı!":
  - /url: /spor/fenerbahceli-fred-transfer-gorusmesini-resmen-acikladi-ba2de4b7
