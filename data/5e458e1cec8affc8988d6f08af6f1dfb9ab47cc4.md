...
- Name: eGündem Test Suite - Hakkımızda Sayfası >> EGT-49 - Ekip üyeleri veya yönetim kadrosu listelenmeli
- Location: /home/runner/work/egundem/egundem/tests/hakkımızda.spec.js:36:3
...
Locator: locator('text=ekip, yönetim, takım, personel')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('text=ekip, yönetim, takım, personel')

    at /home/runner/work/egundem/egundem/tests/hakkımızda.spec.js:39:30
```
