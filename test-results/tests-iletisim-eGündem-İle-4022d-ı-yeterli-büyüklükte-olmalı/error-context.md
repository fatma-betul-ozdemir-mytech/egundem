...
- Name: eGündem İletişim Sayfası Testleri >> EGT-43 - Formdaki mesaj alanı yeterli büyüklükte olmalı
- Location: C:\Users\Kasa\Documents\egundem\tests\iletisim.spec.js:61:3
...
Locator: locator('textarea[name="mesaj"]')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('textarea[name="mesaj"]')

    at C:\Users\Kasa\Documents\egundem\tests\iletisim.spec.js:63:28
```
