...
- Name: eGündem - Köşe Yazıları Sayfası Testleri >> EGT-19 - Yazı detayına ulaşılmalı
- Location: C:\Users\Kasa\Documents\egundem\tests\koseyazilari.spec.js:31:3
...
Call log:
  - waiting for locator('a[href*="/kose-yazilari/"]').first()

    at C:\Users\Kasa\Documents\egundem\tests\koseyazilari.spec.js:34:24
```
...
- link "E-Gündem Haberleri & Son Dakika Haberleri E-Gündem Logo":
  ...
  - img "E-Gündem Logo"
- link "Kartalkaya otel yangınında yeni gelişme!":
  - /url: /gundem/kartalkaya-otel-yangininda-yeni-gelisme-49956ae1
